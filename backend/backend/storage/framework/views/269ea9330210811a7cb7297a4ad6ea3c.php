...
<body style="font-family: Inter, Arial, sans-serif; line-height: 1.6; color: #000000; background-color: #F5F5F5; margin: 0; padding: 0;">
    <div style="max-width: 600px; margin: 0 auto; background-color: #FFFFFF; padding: 20px;">
        ...
        <div style="background-color: #F5F5F5; padding: 20px; border-radius: 8px; margin-bottom: 20px;">
            <h2 style="color: #000000; margin-top: 0; font-size: 20px;">New Donation Received</h2>
            <p style="color: #000000;">Hello Admin,</p>
            <p style="color: #000000;">A new donation has been received on the platform.</p>
            ...
            <div style="background-color: #FFFFFF; border: 2px solid #E60000; padding: 20px; margin: 20px 0; border-radius: 8px;">
                ...
                <table style="width: 100%; border-collapse: collapse;">
                    <tr>
                        <td style="padding: 8px 0; font-weight: bold; color: #333333;">Donor Name:</td>
                        <td style="padding: 8px 0; color: #000000;"><?php echo e($donation->donor_name); ?></td>
                    </tr>
                    <tr>
                        <td style="padding: 8px 0; font-weight: bold; color: #333333;">Donor Email:</td>
                        <td style="padding: 8px 0; color: #000000;"><?php echo e($donation->donor_email); ?></td>
                    </tr>
                    <?php if($donation->donor_phone): ?>
                    <tr>
                        <td style="padding: 8px 0; font-weight: bold; color: #333333;">Donor Phone:</td>
                        <td style="padding: 8px 0; color: #000000;"><?php echo e($donation->donor_phone); ?></td>
                    </tr>
                    <?php endif; ?>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td style="padding: 8px 0; color: #000000;"><?php echo e(ucfirst(str_replace('-', ' ', $donation->type))); ?></td>
                    </tr>
...
<?php /**PATH F:\Al Gohar Foundation\backend\resources\views/emails/admin/new-donation.blade.php ENDPATH**/ ?>