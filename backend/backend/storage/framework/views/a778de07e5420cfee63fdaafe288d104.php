            ...
            <div style="background-color: #FFFFFF; border: 2px solid #E60000; padding: 20px; margin: 20px 0; border-radius: 8px;">
                ...
                <table style="width: 100%; border-collapse: collapse;">
                    <tr>
                        ...
                        <td style="padding: 8px 0; color: #000000;">#<?php echo e($user->id); ?></td>
                    </tr>
                    <tr>
                        <td style="padding: 8px 0; font-weight: bold; color: #333333;">Name:</td>
                        <td style="padding: 8px 0; color: #000000;"><?php echo e($user->name); ?></td>
                    </tr>
                    <tr>
                        <td style="padding: 8px 0; font-weight: bold; color: #333333;">Email:</td>
                        <td style="padding: 8px 0; color: #000000;"><?php echo e($user->email); ?></td>
                    </tr>
                    <?php if($user->phone): ?>
                    <tr>
                        <td style="padding: 8px 0; font-weight: bold; color: #333333;">Phone:</td>
                        <td style="padding: 8px 0; color: #000000;"><?php echo e($user->phone); ?></td>
                    </tr>
                    <?php endif; ?>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td style="padding: 8px 0; color: #000000;"><?php echo e($user->created_at->format('F d, Y h:i A')); ?></td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td style="padding: 8px 0;">
                            ...
                            <span style="color: #666666;"> (<?php echo e($user->email_verified_at->format('F d, Y h:i A')); ?>)</span>
                        </td>
                    </tr>
                    <?php else: ?>
                    <tr>
...
<?php /**PATH C:\Users\dell\Downloads\AlGohar Foundation Source Code\AlGohar Foundation Source Code\backend\backend\resources\views/emails/admin/new-user.blade.php ENDPATH**/ ?>