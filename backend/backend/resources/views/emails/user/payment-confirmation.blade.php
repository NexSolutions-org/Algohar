...
<body style="font-family: Inter, Arial, sans-serif; line-height: 1.6; color: #000000; background-color: #F5F5F5; margin: 0; padding: 0;">
    <div style="max-width: 600px; margin: 0 auto; background-color: #FFFFFF; padding: 20px;">
        ...
        <div style="background-color: #F5F5F5; padding: 20px; border-radius: 8px; margin-bottom: 20px;">
            <h2 style="color: #000000; margin-top: 0; font-size: 20px;">🎉 Payment Confirmed!</h2>
            <p style="color: #000000;">Dear {{ $donation->donor_name }},</p>
            <p style="color: #000000;">Great news! Your payment has been successfully processed and your donation is now complete.</p>
            
            <div style="background-color: #FFFFFF; border: 2px solid #00AA00; padding: 20px; margin: 20px 0; border-radius: 8px;">
                <h3 style="color: #00AA00; margin-top: 0; font-size: 18px; border-bottom: 2px solid #00AA00; padding-bottom: 10px;">Payment Details</h3>
                <table style="width: 100%; border-collapse: collapse;">
                    ...
                    <tr>
                        <td style="padding: 8px 0; font-weight: bold; color: #333333;">Amount Paid:</td>
                        <td style="padding: 8px 0; font-size: 18px; font-weight: bold; color: #00AA00;">PKR {{ number_format($payment->amount, 2) }}</td>
                    </tr>
                    ...
                    @endif
                    <tr>
                        <td style="padding: 8px 0; font-weight: bold; color: #333333;">Payment Date:</td>
                        <td style="padding: 8px 0; color: #000000;">{{ $payment->processed_at ? $payment->processed_at->format('F d, Y h:i A') : now()->format('F d, Y h:i A') }}</td>
                    </tr>
                </table>
            </div>

            <div style="background-color: #E8F5E9; border: 2px solid #00AA00; padding: 15px; margin: 20px 0; border-radius: 8px;">
                <p style="color: #000000; margin: 0; font-weight: bold;">✅ Status: Completed</p>
        ...
        <div style="text-align: center; margin-top: 30px; padding-top: 20px; border-top: 1px solid #E0E0E0;">
            ...
            <div style="margin-top: 15px; padding-top: 15px; border-top: 1px solid #E0E0E0;">
                <p style="color: #000000; font-size: 13px; font-weight: bold; margin: 5px 0;">Questions?</p>
                @if($companyEmail)
