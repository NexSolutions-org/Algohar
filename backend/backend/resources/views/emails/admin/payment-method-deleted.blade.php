...
<head>
    ...
    <title>Payment Method Deleted</title>
</head>
<body style="font-family: Inter, Arial, sans-serif; line-height: 1.6; color: #000000; background-color: #F5F5F5; margin: 0; padding: 0;">
    <div style="max-width: 600px; margin: 0 auto; background-color: #FFFFFF; padding: 20px;">
        ...
        <div style="background-color: #F5F5F5; padding: 20px; border-radius: 8px; margin-bottom: 20px;">
            <h2 style="color: #000000; margin-top: 0; font-size: 20px;">Payment Method Deleted</h2>
            <p style="color: #000000;">Hello Admin,</p>
            <p style="color: #000000;">A user has deleted a payment method from their account.</p>
            ...
            <div style="background-color: #FFFFFF; border: 2px solid #E60000; padding: 20px; margin: 20px 0; border-radius: 8px;">
                ...
                <table style="width: 100%; border-collapse: collapse;">
                    <tr>
                        ...
                        <td style="padding: 8px 0; color: #000000;">{{ $user->name }} ({{ $user->email }})</td>
                    </tr>
                    <tr>
                        <td style="padding: 8px 0; font-weight: bold; color: #333333;">Payment Method Type:</td>
                    ...
                    <tr>
                        ...
                        <td style="padding: 8px 0; color: #000000;">{{ ucfirst($paymentMethodProvider) }}</td>
                    </tr>
                    @endif
                    <tr>
                        <td style="padding: 8px 0; font-weight: bold; color: #333333;">Deleted At:</td>
                        <td style="padding: 8px 0; color: #000000;">{{ now()->format('F d, Y h:i A') }}</td>
                    </tr>
                </table>
            </div>
        </div>
