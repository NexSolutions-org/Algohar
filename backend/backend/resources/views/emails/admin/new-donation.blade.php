            ...
            <div style="background-color: #FFFFFF; border: 2px solid #E60000; padding: 20px; margin: 20px 0; border-radius: 8px;">
                ...
                <table style="width: 100%; border-collapse: collapse;">
                    <tr>
                        ...
                        <td style="padding: 8px 0; color: #000000;">{{ $donation->donor_name }}</td>
                    </tr>
                    <tr>
                        <td style="padding: 8px 0; font-weight: bold; color: #333333;">Donor Email:</td>
                        <td style="padding: 8px 0; color: #000000;">{{ $donation->donor_email }}</td>
                    </tr>
                    @if($donation->donor_phone)
                    <tr>
                        <td style="padding: 8px 0; font-weight: bold; color: #333333;">Donor Phone:</td>
                        <td style="padding: 8px 0; color: #000000;">{{ $donation->donor_phone }}</td>
                    </tr>
                    @endif
                    <tr>
                    ...
                    <tr>
                        ...
                        <td style="padding: 8px 0; color: #000000;">{{ ucfirst(str_replace('-', ' ', $donation->type)) }}</td>
                    </tr>
                    @if($donation->cause)
                    <tr>
