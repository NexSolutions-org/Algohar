...
<head>
    ...
    <title>Donation Status Changed</title>
</head>
<body style="font-family: Inter, Arial, sans-serif; line-height: 1.6; color: #000000; background-color: #F5F5F5; margin: 0; padding: 0;">
    <div style="max-width: 600px; margin: 0 auto; background-color: #FFFFFF; padding: 20px;">
        ...
        <div style="background-color: #F5F5F5; padding: 20px; border-radius: 8px; margin-bottom: 20px;">
            <h2 style="color: #000000; margin-top: 0; font-size: 20px;">Donation Status Changed</h2>
            <p style="color: #000000;">Hello Admin,</p>
            <p style="color: #000000;">A donation status has been updated.</p>
            ...
            <div style="background-color: #FFFFFF; border: 2px solid #E60000; padding: 20px; margin: 20px 0; border-radius: 8px;">
                ...
                <table style="width: 100%; border-collapse: collapse;">
                    ...
                    <tr>
                        ...
                        <td style="padding: 8px 0; color: #000000;">{{ $donation->donor_name }} ({{ $donation->donor_email }})</td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td style="padding: 8px 0;">
                            <span style="background-color: #F5F5F5; color: #333333; border: 1px solid #E0E0E0; padding: 4px 8px; border-radius: 4px; font-size: 12px; font-weight: bold;">
                                {{ ucfirst($oldStatus) }}
                            </span>
                        </td>
                    </tr>
                    <tr>
                        <td style="padding: 8px 0; font-weight: bold; color: #333333;">New Status:</td>
                        <td style="padding: 8px 0;">
                            @php
                                $statusStyles = [
                                    'pending' => ['bg' => '#FFF3F3', 'color' => '#E60000', 'border' => '#E60000'],
                                    'completed' => ['bg' => '#E60000', 'color' => '#FFFFFF', 'border' => '#E60000'],
                                    'failed' => ['bg' => '#FFF3F3', 'color' => '#E60000', 'border' => '#E60000'],
                                    'cancelled' => ['bg' => '#F5F5F5', 'color' => '#333333', 'border' => '#E0E0E0'],
                                ];
                                $style = $statusStyles[$newStatus] ?? $statusStyles['pending'];
                            @endphp
                            <span style="background-color: {{ $style['bg'] }}; color: {{ $style['color'] }}; border: 1px solid {{ $style['border'] }}; padding: 4px 8px; border-radius: 4px; font-size: 12px; font-weight: bold;">
                                {{ ucfirst($newStatus) }}
                            </span>
                        </td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td style="padding: 8px 0; color: #000000;">{{ $donation->updated_at->format('F d, Y h:i A') }}</td>
                    </tr>
                </table>
            </div>
        </div>
